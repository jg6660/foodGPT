...
const useVision = async (args, inquiry = '', context = []) => {
    ...
    // let user_content = [{ type: 'text', text: 'Can you provide me with the ingredients?' }]
...
const useDalle = async (args, lang = 0) => {
    ...
    return image_list.length > 0 ? { 
        ...
        message: image_list.length > 1 ? `Done! Here are the images you requested...` : `Done! Here is the images you requested...`,
        images: image_list 
